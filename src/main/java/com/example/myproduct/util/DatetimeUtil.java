...
public class DatetimeUtil {
  ...
  public static Date parseDate(String date, String format) {
    if (StringUtil.isNullOrEmpty(date) || StringUtil.isNullOrEmpty(format)) {
      return null;
    }
  ...
  public static String formatDateByTimeMillis(Long timeMillis, String format) {
    ...
    if (null != timeMillis && !StringUtil.isNullOrEmpty(format)) {
  ...
  public static boolean hasChild(Date birthDay, Date flightDate) {
    ...
    return birthDay.getTime() <= flightDateCalendar1.getTime().getTime() && birthDay.getTime() >= flightDateCalendar2.getTime().getTime();
  }
